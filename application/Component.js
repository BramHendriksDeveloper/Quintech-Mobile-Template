...
sap.ui.core.UIComponent.extend("com.quintech.mobile.template.Component", {
	...
	init: function() {
		...
		var oRootPath = jQuery.sap.getModulePath("com.quintech.mobile.template");
		...
		var appContext;
		if (com.quintech.mobile.template.dev.devapp.devLogon) {
			appContext = com.quintech.mobile.template.dev.devapp.devLogon.appContext;
		}
