jQuery.sap.require("com.quintech.mobile.template.util.Formatter");
jQuery.sap.require("com.quintech.mobile.template.util.Controller");

com.quintech.mobile.template.util.Controller.extend("com.quintech.mobile.template.view.Detail", {
	...
	onRouteMatched: function(oEvent) {
		...
		jQuery.when(this.oInitialLoadFinishedDeferred).then(jQuery.proxy(function() {
			...
			oIconTabBar.getItems().forEach(function(oItem) {
				oItem.bindElement(com.quintech.mobile.template.util.Formatter.uppercaseFirstChar(oItem.getKey()));
			});
