jQuery.sap.declare("com.quintech.mobile.template.dev.devapp");
jQuery.sap.require("com.quintech.mobile.template.dev.devlogon");

com.quintech.mobile.template.dev.devapp = {
	smpInfo: {},
	externalURL: null,
	...
	onDeviceReady: function() {
		if (window.sap_webide_FacadePreview) {
			...
			var that = com.quintech.mobile.template.dev.devapp;
			$.getJSON(".project.json", function(data) {
				...
				if (that.smpInfo.server && that.smpInfo.server.length > 0) {
					...
					that.devLogon = new com.quintech.mobile.template.dev.devlogon();
